...
import br.unicamp.tretacamp.modelo.EfeitoEnfraquecer;
import br.unicamp.tretacamp.modelo.EfeitoQueimar;
...
public class ConfiguracaoPoder {
	...
	private final static ArrayList<Efeito> EFEITOS_PEPITA_MAGICA =
		new ArrayList<>(Arrays.asList(new EfeitoEnfraquecer(3.0, 2)));
	...
	private final static ArrayList<Efeito> EFEITOS_BOLA_DE_FOGO =
		new ArrayList<>(Arrays.asList(new EfeitoQueimar(2.0, 3)));
